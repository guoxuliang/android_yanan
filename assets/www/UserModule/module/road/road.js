...
;define(function(require, exports, module){
	...
	module.exports = {
		onCreate : function(winObj){
			...
			// aigovApp.ajax("UserModule/module/road/road.json", null, function(data){
				aigovApp.utils.closeLoading();
				$("#J_road_view_centen").width(120*data.data.length);
				$.each(data.data,function(i,o){
					...
					$("#J_road_view_centen").append(html);
				});
				new IScroll('#J_road_view_box', {scrollX: true, scrollY: false, mouseWheel: true});
