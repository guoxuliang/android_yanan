...
;define(function(require, exports, module){
	...
	var load = function(winObj){		
		var url = aigovApp.constants.hotLine.CITY_VOICE_LIST;
...
//		});
	   ...
	   // this.intent=winObj.intent;
	    ...
	    documentList._loadHtml(componentPath + 'template/cityVoiceList.html',function(tplHtml){
	...
	module.exports = {
		...
		onCreate : function(winObj){
			...
			var btnHtml = '<a href="javascript:void(0);" id="factBtn" onclick="aigovApp.openAppWindow(\'fact\');">我要爆料</a>'
